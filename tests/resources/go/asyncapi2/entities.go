...
type marshalMessageOneOf1OneOf1CorrelationID MessageOneOf1OneOf1CorrelationID
...
func (i MessageOneOf1OneOf1CorrelationID) MarshalJSON() ([]byte, error) {
	return marshalUnion(marshalMessageOneOf1OneOf1CorrelationID(i), i.Reference, i.CorrelationID)
}
...
type marshalMessageOneOf1 MessageOneOf1
...
func (i MessageOneOf1) MarshalJSON() ([]byte, error) {
	return marshalUnion(marshalMessageOneOf1(i), i.OneOf0, i.OneOf1)
}
...
func (i Message) MarshalJSON() ([]byte, error) {
	return marshalUnion(marshalMessage(i), i.Reference, i.OneOf1)
}
